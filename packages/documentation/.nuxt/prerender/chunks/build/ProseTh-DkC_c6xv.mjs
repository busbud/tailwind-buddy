...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<th${ssrRenderAttrs(mergeProps({ class: "border px-4 py-2 text-left font-bold [&[align=center]]:text-center [&[align=right]]:text-right" }, _attrs))}>`);
...
//# sourceMappingURL=ProseTh-DkC_c6xv.mjs.map
