import _sfc_main$1 from './Alert-BcZNGmOu.mjs';
import { defineComponent, computed, mergeProps, withCtx, unref, createTextVNode, createVNode, toDisplayString, useSSRContext } from 'file:///Users/florentgiraud/dev/busbud/tailwind-classes-authority/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrInterpolate } from 'file:///Users/florentgiraud/dev/busbud/tailwind-classes-authority/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/server-renderer/index.mjs';
import 'file:///Users/florentgiraud/dev/busbud/tailwind-classes-authority/node_modules/.pnpm/class-variance-authority@0.7.0/node_modules/class-variance-authority/dist/index.mjs';
import './Icon-CBPqgZrW.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    function createBreadcrumb(link = "here") {
      if (link.startsWith("http"))
        return link.replace(/^https?:\/\//, "");
      return link.split("/").filter(Boolean).join(" > ").replace("Api", "API");
    }
    const computedTitle = computed(() => props.title || createBreadcrumb(props.to));
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Alert, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Read more in <span class="capitalize font-semibold"${_scopeId}>${ssrInterpolate(unref(computedTitle))}</span>`);
          } else {
            return [
              createTextVNode(" Read more in "),
              createVNode("span", { class: "capitalize font-semibold" }, toDisplayString(unref(computedTitle)), 1)
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=ReadMore-HZ0pvkYz.mjs.map
