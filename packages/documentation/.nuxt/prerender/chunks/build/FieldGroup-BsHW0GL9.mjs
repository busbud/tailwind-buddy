...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "divide-y [&:not(:first-child)]:mt-6" }, _attrs))}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/content/FieldGroup.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const FieldGroup = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { FieldGroup as default };
//# sourceMappingURL=FieldGroup-BsHW0GL9.mjs.map
