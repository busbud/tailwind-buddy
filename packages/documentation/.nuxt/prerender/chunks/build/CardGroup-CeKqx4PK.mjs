...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid md:grid-cols-2 gap-4 group" }, _attrs))}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/content/CardGroup.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const CardGroup = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { CardGroup as default };
//# sourceMappingURL=CardGroup-CeKqx4PK.mjs.map
