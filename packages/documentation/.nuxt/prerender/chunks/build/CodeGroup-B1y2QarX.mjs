import { defineComponent, useSlots, useSSRContext, h } from 'file:///Users/florentgiraud/dev/busbud/tailwind-classes-authority/node_modules/.pnpm/vue@3.4.27_typescript@5.4.5/node_modules/vue/index.mjs';
...
import _sfc_main$1 from './Tabs-C7vk5y2C.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function render() {
      var _a;
      const slots = ((_a = _slots == null ? void 0 : _slots.default) == null ? void 0 : _a.call(_slots)) || [];
      return h(_sfc_main$1, { variant: "card" }, slots);
    }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/content/CodeGroup.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=CodeGroup-B1y2QarX.mjs.map
