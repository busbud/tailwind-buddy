...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<code${ssrRenderAttrs(mergeProps({ class: "relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono inline-code" }, _attrs))} data-v-fc88e0d7>`);
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-fc88e0d7"]]);

export { __nuxt_component_5 as default };
//# sourceMappingURL=ProseCodeInline-B2S5TP1h.mjs.map
